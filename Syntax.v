...
Notation "'while' e 'do' '{' c1 '}'" := (CWhile e c1)
  (in custom prog_lang_entry at level 19,
   e custom prog_lang_entry at level 5,
   c1 custom prog_lang_entry at level 99).
Notation "'input' x" := (CInput x)
  (in custom prog_lang_entry at level 10, format "'input'  x").
Notation "'output' e" := (COutput e)
  (in custom prog_lang_entry at level 10, format "'output'  e").
